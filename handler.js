...
${user.bannedReason}` : '💌 *Motivo:* Sin Especificar'}\n\n⚠️ *Si este bot es cuenta oficial y tiene evidencia que respalde que este mensaje es un error, puede exponer su caso en:*\n\n🤍 ${asistencia}`)
                ...
                let hl = _prefix
                let adminMode = global.db.data.chats[m.chat].modoadmin; // Modo Admin activado/desactivado
...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *JAXXBOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *JAXXBOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *JAXXBOT*.`,
